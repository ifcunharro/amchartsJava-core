...
public class GaugeArrowControllerTest {
	...
	@Test
	public void innerRadius_property_must_return_string_if_set_method_recive_percent_value_as_string() throws CoordException{
		GaugeArrowController gaugeArrow = new GaugeArrowController();
	...
	@Test
	public void innerRadius_property_launch_exception_if_set_methot_not_recive_integer_or_percent_as_string() throws CoordException{
		thrown.expect(CoordException.class);
		thrown.expectMessage("Format coords must be an integer number or a percent");
		GaugeArrowController gaugeArrow = new GaugeArrowController();
