...
public class GaugeBandControllerTest {
	...
	@Test
	public void radius_and_innerRadius_properties_must_return_string_if_set_method_recive_percent_value_as_string() throws CoordException{
		GaugeBandController gaugeBand = new GaugeBandController();
	...
	@Test
	public void radius_and_innerRaidus_properties_launch_exception_if_set_methot_not_recive_integer_or_percent_as_string() throws CoordException{
