...
public final class ColorValidator {
	 ...
	 */
	public static boolean checkFormatColor(final String color) throws ColorException{
		if(color != null){
	 ...
	 * @throws ColorException Format color doesn't admitted, format admitted: #ffffff
	 */
	public static boolean checkFormatColors(final String... colors) throws ColorException{
	 ...
	 */
	public static boolean canActivateNegativeColor(final String graphType){
